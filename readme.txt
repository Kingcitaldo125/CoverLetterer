...
Uses some generic cover letter templates that I was able to unearth on the internet.
...
To run, either run the main.bat script or the python script. The cover letter is saved in a file called 'out.txt'.
